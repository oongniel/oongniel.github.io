...
import PageDetailsTypeA from './pages/PageDetails/ContentLeftImageRight';
import PageDetailsTypeB from './pages/PageDetails/NumericalData';
import PageDetailsTypeC from './pages/PageDetails/MultipleViews';
import PageDetailsTypeD from './pages/PageDetails/ImageAndGallery';
import PageDetailsTypeE from './pages/PageDetails/ContentHeadingCenter';
  ...
  getTemplate = (template, params) => {
    ...
    switch (template) {
      ...
      case 'page-details-d':
        ...
        break;
      case 'page-details-e':
        temp = <PageDetailsTypeE params={params} />;
        break;
      default:
        break;
    }
